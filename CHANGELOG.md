...
- **See-through hover cards, as an option.** Turn on **Hover cards are
  slightly see-through, with what's behind them blurred** (it's off by
  default) and the tab, folder and essential cards get the same frosted
  look as the compact sidebar and the address bar pop-up.
